...
public class Restaurant {
    ...
    @Expose
    private List<EstablishmentTypes> establishmentTypes;
    ...
    public List<EstablishmentTypes> getEstablishmentTypes() {
        return establishmentTypes;
    }

    public void setEstablishmentTypes(List<EstablishmentTypes> establishmentTypes) {
